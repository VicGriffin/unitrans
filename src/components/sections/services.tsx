...
import { University, FileText, BookOpen, DollarSign, Home, Plane, Users, Briefcase, Award, Languages, ChevronDown, ChevronUp } from "lucide-react"
  ...
  const services = [
    {
      ...
      description: "We assist students in choosing right program and institution, preparing compiling applications and ensuring timely admissions into globally recognized universities.",
          ...
          {services.map((service, index) => (
            <Card key={index} className="border-2 border-gray-100 hover:border-blue-200 transition-shadow">
              <Collapsible
                ...
                onOpenChange={(open) => setOpenService(open ? index : null)}
              >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-start space-x-4">
                        ...
                        <div className="flex-1 text-left">
                          ...
                          <p className="text-gray-600 leading-relaxed max-w-3xl">{service.description}</p>
                        </div>
                      </div>
                      <div className="ml-4">
                        {openService === index ? (
